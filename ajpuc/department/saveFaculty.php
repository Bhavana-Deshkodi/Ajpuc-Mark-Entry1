...
$sql = "INSERT INTO `faculty` (`Fname`,`Lname`,`Phone_No`,`Email_ID`,`Add_1`,`Add_2`,`Pincode`,`Status`,`Gender`,`Qualification`,`password`) 
                    VALUES ('$fname', '$lname', '$fnum', '$fcemail','$add1','$add2','$pincode', '$status', '$Gender', '$highqual','$fcpass')";
